...
case "$PETALINUX_BOARD_PROJECT" in
    ...
    "factest")
        ...
        ;;
    "duo")
        ${KCONFIG_EDIT} --file ${CONFIG_FILE} --set-str CONFIG_YOCTO_MACHINE_NAME 'k24-iocc-duo';
        ${KCONFIG_EDIT} --file ${CONFIG_FILE} --set-str CONFIG_YOCTO_INCLUDE_MACHINE_NAME 'k24-iocc-duo';
        ;;
