...
${KCONFIG_EDIT} --file ${CONFIG_FILE} --disable CONFIG_SUBSYSTEM_PMUFW_SERIAL_PSU_UART_0_SELECT
${KCONFIG_EDIT} --file ${CONFIG_FILE} --disable CONFIG_SUBSYSTEM_FSBL_SERIAL_PSU_UART_0_SELECT
${KCONFIG_EDIT} --file ${CONFIG_FILE} --disable CONFIG_SUBSYSTEM_ATF_SERIAL_PSU_UART_0_SELECT
${KCONFIG_EDIT} --file ${CONFIG_FILE} --disable CONFIG_SUBSYSTEM_SERIAL_PSU_UART_0_SELECT
