...
{ 
  ...
  if [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.fmc_network1_factest.patch ] 
    then
    echo " "
    ...
    cd ${START_FOLDER}/${PETALINUX_PROJECTS_FOLDER}/${PETALINUX_PROJECT_NAME}
  elif [ -f ${START_FOLDER}/${PETALINUX_CONFIGS_FOLDER}/project/config.${HDL_PROJECT_NAME}.patch ] 
    then
    echo " "
