...
# ----------------------------------------------------------------------------
#
#  Create Date:         Sep 25, 2021
#  Design Name:         UltraZed-EV HDMI (+VCU) (+NVME) BSP
#  Module Name:         rebuild_uz7ev_evcc_hdmi_v_n.sh
#  Project Name:        UltraZed-EV HDMI_V_N BSP
