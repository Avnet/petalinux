...
#
#  Description:         Boot Script for Ultrazed Boards, to boot a initrd image from jtag + tftp with dhcp
#
#  Dependencies:        None
#
#  Revision:            Oct 2, 2020: 1.00 Initial version
#
# ----------------------------------------------------------------------------
