...
#  Design Name:         Avnet Ultra96v2 PetaLinux
#  Module Name:         boot_jtag_INITRD.tcl
#  Project Name:        Avnet Ultra96v2 PetaLinux
#  Target Devices:      Xilinx Zynq Ultrascale MPSoC
#  Hardware Boards:     Ultra96v2 Eval Board
#
#  Tool versions:       Xilinx Vivado 2020.1
#
#  Description:         Boot Script for Ultra96v2, to boot an initrd image from jtag
#
#  Dependencies:        None
#
...
after 2000
targets -set -nocase -filter {name =~ "*A53*#0"}
puts stderr "INFO: Loading image: ./pre-built/linux/images/image_INITRD.ub at 0x04000000"
dow -data  "./pre-built/linux/images/image_INITRD.ub" 0x04000000
after 2000
targets -set -nocase -filter {name =~ "*A53*#0"}
puts stderr "INFO: Loading image: ./pre-built/linux/images/avnet-boot/avnet_jtag.scr at 0x20000000"
dow -data  "./pre-built/linux/images/avnet-boot/avnet_jtag.scr" 0x20000000
after 2000
targets -set -nocase -filter {name =~ "*A53*#0"}
