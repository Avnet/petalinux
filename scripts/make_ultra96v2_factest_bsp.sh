...
HDL_HARDWARE_NAME=ultra96v2_factest_hw
HDL_PROJECT_NAME=ultra96v2_factest
...
main_make_function ()
{
  ...
  PETALINUX_PROJECT_NAME=ultra96v2_factest_${PLNX_VER}
  PETALINUX_ROOTFS_NAME=ultra96v2_factest
  build_hw_platform
  create_petalinux_bsp
}
