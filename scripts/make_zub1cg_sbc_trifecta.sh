...
# ----------------------------------------------------------------------------
#
#  Create Date:         April 15, 2024
#  Design Name:         ZUBoard-1CG Trifecta HSIO BSP
#  Module Name:         make_zub1cg_sbc_trifecta.sh
#  Project Name:        ZUBoard-1CG Trifecta
